...
module myproject_shift_line_buffer_array_ap_fixed_8_3_5_3_0_1u_config2_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
myproject_shift_line_buffer_array_ap_fixed_8_3_5_3_0_1u_config2_s_void_conv_2d_buffer_cbkb #(
    .DataWidth( 8 ),
    .AddressRange( 63 ),
    .AddressWidth( 6 ))
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        void_compute_output_buffer_2d_array_const_ap_shift_reg_n_chan_stream_weig_13_o = void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_1_q0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        void_compute_output_buffer_2d_array_const_ap_shift_reg_n_chan_stream_weig_16_o = void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_q0;
    end else begin
...
endmodule //myproject_shift_line_buffer_array_ap_fixed_8_3_5_3_0_1u_config2_s
